        ...
        <div>
            {
              ...
              <div className="col-md-3 col-4">
                  ...
                  <div className="pt-3">
                      ...
                      <span id="facebook" className="fb-icon fw-bolder"><FaFacebookF className="fs-md-4 fs-6"/> <span className="px-md-1 px-0 " id="followService">Follwers 9.8k</span> </span> 

                      <span id="youtube" className="fw-bolder"><AiFillYoutube className="fs-md-4 fs-6"/> <span className="px-md-2 px-0" id="followService">Subscriber 2.3M</span> </span> 
                      
                       <span id="twiter" className="fw-bolder"><BsTwitter className="fs-md-4 fs-6"/> <span className="px-1 px-0" id="followService">Subscriber 2.3M</span> </span> 

                       <span id="instagram" className="fw-bolder"><AiFillInstagram className="fs-md-4 fs-6"/> <span className="px-1 px-0" id="followService">Follwers 11.2k</span> </span> 
                      </p>
                  </div>
                  <div>
                  ...
                  <form action="#" id="form">
                      <input id="contactSet" type="email" placeholder="Email" />
                      <textarea id="contactSet" name="" placeholder="Write your message..."></textarea> <br />
